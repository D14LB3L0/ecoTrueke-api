...
namespace EcoTrueke.Infrastructure.Communications
{
    public class MailerService : IMailerService
    {
        ...
        public async Task<Result> SendMailResetPassword(User user, Person person, string newPassword)
        {
            ...
            await SendSupportCallMail(user.Email, "Solicitud de contraseña", "Restablecer contraseña", $"Hola {person.FirstName} {person.PaternalSurname} {person.MaternalSurname}", content);
